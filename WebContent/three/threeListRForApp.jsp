...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="threeListRForApp.jsp">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="page-header">
						  <h1 align="center"><span class="glyphicon glyphicon-list-alt" style="vertical-align: middle;"></span>&nbsp;신청학생명단</h1>
					</div>
				</div>
				<div class="col-md-12">
				                    	...
				                    	<c:forEach items="${dsThreeList}" var="dsThreeList" varStatus="courseIdx">
				                         <tr>
				                            ...
				                            <td style="text-align: center; vertical-align: middle;">
												<button type="button" class="btn btn-danger" onclick="fn_updateAppStatus('${dsThreeList.APP_CODE}', 1)">불합격</button>
												<button type="button" class="btn btn-success" onclick="fn_updateAppStatus('${dsThreeList.APP_CODE}', 2)">합격</button>
				                            </td>
				                         </tr>
					                    </c:forEach>
				                    </tbody>
