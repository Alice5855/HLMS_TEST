			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="page-header">
						  <h1 align="center"><span class="glyphicon glyphicon-list-alt" style="vertical-align: middle;"></span>&nbsp;성적조회</h1>
					</div>
				</div>
				<div class="col-md-6 col-md-offset-3">
				                    ...
				                    <tbody>
				                    	<c:forEach items="${dsCourseForScoreList}" var="dsCourseForScoreList" varStatus="courseIdx">
				                         <tr>
				                            ...
				                            <td style="text-align: center; vertical-align: middle;">${dsCourseForScoreList.SCORE}</td>
				                         </tr>
					                    </c:forEach>
				                    </tbody>
				                </table>
