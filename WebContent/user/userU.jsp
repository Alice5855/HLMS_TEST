...
<head>
	...
	function fn_setDetailInfo(){
		...
		$("#nickName").val('${dsUser.nickName}');

		$("#name").val('${dsUser.name}');
		$("#birth").val('${dsUser.birth}');
		$("#grade").val('${dsUser.grade}');
...
<jsp:include page="../common/top.jsp"></jsp:include>
	<div id="jumbotron" class="container">
		<div class="jumbotron jumbotron-info">
			<h1><strong>정보수정</strong>&nbsp;<span class="glyphicon glyphicon glyphicon-pencil"></span></h1>
		</div>
	</div>
	<div class="container">
	<div class="form-area">
	<form id="joinFrm" method="post" action="${context}/work/user/updateUser.do" role="form">
		<div class="form-horizontal">
			...
			<div class="form-group">
				<label for="email" class="control-label col-md-2"><b>닉네임</b></label>
				<div class="col-md-4">
					<input class="form-control" type="text" name="nickName" id="nickName" required="required"/>
				</div>
			</div>

			<div class="form-group">
				<label for="email" class="control-label col-md-2"><b>CLASS</b></label>
				<div class="col-md-4">
					<input class="form-control" type="text" name="class2" id="class2" required="required"/>
				</div>
			</div>
			...
			<div class="form-group">
				<label for="grade" class="control-label col-md-2"><b>구분</b></label>
				<div class="col-md-2">
		        	<select class="form-control" id="grade" name="grade" required="required" required="required">
		...
		<form id="ajaxform" action="${context}/work/board/saveFile.do" method="post" enctype="multipart/form-data" role="form">
		<div class="form-group">
